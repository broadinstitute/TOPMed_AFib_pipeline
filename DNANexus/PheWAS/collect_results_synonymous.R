...
single_cauchy_row <- t(as.data.frame(c("gene",
                                       ...
                                       "Score__synonymous_canonical0.001",
                                       "Score.SE__synonymous_canonical0.001",
                                       "Est__synonymous_canonical0.001",
                                       "Est.SE__synonymous_canonical0.001",
                                       "SPA.pval__synonymous_canonical0.001",
                                       "Score__synonymous_canonical0.00001",
                                       "Score.SE__synonymous_canonical0.00001",
                                       "Est__synonymous_canonical0.00001",
                                       "Est.SE__synonymous_canonical0.00001",
                                       "SPA.pval__synonymous_canonical0.00001",
                                       "P_cauchy"
)))
...
for(i in c(1:nrow(key))){
  ...
  cat('\n\n\nBusy with phenotype', num, 'which is', phenoname, 'and task', i, 'out of 549 tasks...\n\n')
  files <- paste0("/mnt/project/sjj/projects/phewas/v1/results/association/synonymous/", num, "_results_chr", c(1:22), "_maf0.001.RData")
  files2 <- paste0("/mnt/project/sjj/projects/phewas/v1/results/association/synonymous/", num, "_results_chr", c(1:22), "_maf0.00001.RData")
  if(all(file.exists(files)) & all(file.exists(files2))){
    ...
    rownames(inter) <- paste0(rownames(inter), "__synonymous_canonical0.001")
    ...
    inter1 <- inter[inter$mask=="synonymous_canonical0.001", c("phenotype", "cases", "controls", "gene", "Score", "Score.SE", "Est", "Est.SE", "SPA.pval")]
    colnames(inter1)[c(5:9)] <- paste0(colnames(inter1)[c(5:9)], "__synonymous_canonical0.001")
    inter2 <- inter[inter$mask=="synonymous_canonical0.00001", c("gene", "Score", "Score.SE", "Est", "Est.SE", "SPA.pval")]
    colnames(inter2)[c(2:6)] <- paste0(colnames(inter2)[c(2:6)], "__synonymous_canonical0.00001")
