...
#MAF<0.1% files
#for(chr in c(1:22)){
#    try(system(paste0("dx download exome-seq:/sjj/projects/phewas/v1/results/association/round2/lowmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.001_round2_lowmem_EUR.RData")))
#    try(system(paste0("dx download exome-seq:/sjj/projects/phewas/v1/results/association/round2/highmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.001_round2_highmem_EUR.RData")))
#    if(chr %in% c(1:20, 22)){
#        try(system(paste0("dx download exome-seq:/sjj/projects/phewas/v1/results/association/round2/highhighmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.001_round2_highhighmem_EUR.RData")))
#    }
#    if(chr %in% c(1:8, 10:13, 15:17, 19:20)){
#        try(system(paste0("dx download exome-seq:/sjj/projects/phewas/v1/results/association/round2/veryhighmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.001_round2_veryhighmem_EUR.RData")))
#    }
...
for(chr in c(1:22)){
    ...
    if(chr %in% c(1:20, 22)){
        files <- paste0(files, " ", paste0("exome-seq:/sjj/projects/phewas/v1/results/association/round2/highhighmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.001_round2_highhighmem_EUR.RData"))
    }
    if(chr %in% c(1:8, 10:13, 15:17, 19:20)){
        files <- paste0(files, " ", paste0("exome-seq:/sjj/projects/phewas/v1/results/association/round2/veryhighmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.001_round2_veryhighmem_EUR.RData"))
    }
    files <- paste0(files, " ", paste0("exome-seq:/sjj/projects/phewas/v1/results/association/", num, "_results_chr", chr, "_maf0.001_EUR.RData"))
}
#files1_1 <- paste0("/mnt/project/sjj/projects/phewas/v1/results/association/round2/lowmem/chr", c(1:22), '/', num, "_results_chr", c(1:22), "_maf0.001_round2_lowmem_EUR.RData")
#files1_2 <- paste0("/mnt/project/sjj/projects/phewas/v1/results/association/round2/highmem/chr", c(1:22), '/', num, "_results_chr", c(1:22), "_maf0.001_round2_highmem_EUR.RData")
#files1_3 <- paste0("/mnt/project/sjj/projects/phewas/v1/results/association/round2/highhighmem/chr", c(1:20, 22), '/', num, "_results_chr", c(1:20, 22), "_maf0.001_round2_highhighmem_EUR.RData")
#files1_4 <- paste0("/mnt/project/sjj/projects/phewas/v1/results/association/round2/veryhighmem/chr", c(1:8, 10:13, 15:17, 19:20), '/', num, "_results_chr", c(1:8, 10:13, 15:17, 19:20), "_maf0.001_round2_veryhighmem_EUR.RData")
#files1_5 <- paste0("/mnt/project/sjj/projects/phewas/v1/results/association/", num, "_results_chr", c(1:22), "_maf0.001_EUR.RData")
files1_1 <- paste0(num, "_results_chr", c(1:22), "_maf0.001_round2_lowmem_EUR.RData")
files1_2 <- paste0(num, "_results_chr", c(1:22), "_maf0.001_round2_highmem_EUR.RData")
files1_3 <- paste0(num, "_results_chr", c(1:20, 22), "_maf0.001_round2_highhighmem_EUR.RData")
files1_4 <- paste0(num, "_results_chr", c(1:8, 10:13, 15:17, 19:20), "_maf0.001_round2_veryhighmem_EUR.RData")
files1_5 <- paste0(num, "_results_chr", c(1:22), "_maf0.001_EUR.RData")
maf0.001_files <- c(files1_1, files1_2, files1_3, files1_4, files1_5)
maf0.001_nfilesets <- 5

#MAF<0.001% files
#for(chr in c(1:22)){
#    try(system(paste0("dx download exome-seq:/sjj/projects/phewas/v1/results/association/round2/lowmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.00001_round2_lowmem_EUR.RData")))
#    try(system(paste0("dx download exome-seq:/sjj/projects/phewas/v1/results/association/round2/highmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.00001_round2_highmem_EUR.RData")))
#    try(system(paste0("dx download exome-seq:/sjj/projects/phewas/v1/results/association/round2/highhighmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.00001_round2_highhighmem_EUR.RData")))
#    if(chr %in% c(1:17, 19:20)){
#        try(system(paste0("dx download exome-seq:/sjj/projects/phewas/v1/results/association/round2/veryhighmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.00001_round2_veryhighmem_EUR.RData")))
#    }
#    try(system(paste0("dx download exome-seq:/sjj/projects/phewas/v1/results/association/round3/lowmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.00001_round3_lowmem_EUR.RData")))
#    try(system(paste0("dx download exome-seq:/sjj/projects/phewas/v1/results/association/round3/highmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.00001_round3_highmem_EUR.RData")))
#    if(chr %in% c(1:20, 22)){
#        try(system(paste0("dx download exome-seq:/sjj/projects/phewas/v1/results/association/round3/highhighmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.00001_round3_highhighmem_EUR.RData")))
#    }
#    if(chr %in% c(1:6, 8, 12:13, 15:16, 19)){
#        try(system(paste0("dx download exome-seq:/sjj/projects/phewas/v1/results/association/round3/veryhighmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.00001_round3_veryhighmem_EUR.RData")))
#    }
#    # Old MAF<0.001% run with some errors
#    try(system(paste0("dx download exome-seq:/sjj/projects/phewas/v1/results/association/", num, "_results_chr", chr, "_maf0.00001_EUR.RData")))
#}
for(chr in c(1:22)){
    files <- paste0(files, " ", paste0("exome-seq:/sjj/projects/phewas/v1/results/association/round2/lowmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.00001_round2_lowmem_EUR.RData"))
    files <- paste0(files, " ", paste0("exome-seq:/sjj/projects/phewas/v1/results/association/round2/highmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.00001_round2_highmem_EUR.RData"))
    files <- paste0(files, " ", paste0("exome-seq:/sjj/projects/phewas/v1/results/association/round2/highhighmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.00001_round2_highhighmem_EUR.RData"))
    if(chr %in% c(1:17, 19:20)){
        files <- paste0(files, " ", paste0("exome-seq:/sjj/projects/phewas/v1/results/association/round2/veryhighmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.00001_round2_veryhighmem_EUR.RData"))
    }
    files <- paste0(files, " ", paste0("exome-seq:/sjj/projects/phewas/v1/results/association/round3/lowmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.00001_round3_lowmem_EUR.RData"))
    files <- paste0(files, " ", paste0("exome-seq:/sjj/projects/phewas/v1/results/association/round3/highmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.00001_round3_highmem_EUR.RData"))
    if(chr %in% c(1:20, 22)){
        files <- paste0(files, " ", paste0("exome-seq:/sjj/projects/phewas/v1/results/association/round3/highhighmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.00001_round3_highhighmem_EUR.RData"))
    }
    if(chr %in% c(1:6, 8, 12:13, 15:16, 19)){
...
#files2_3 <- paste0("/mnt/project/sjj/projects/phewas/v1/results/association/round2/highhighmem/chr", c(1:22), '/', num, "_results_chr", c(1:22), "_maf0.00001_round2_highhighmem_EUR.RData")
#files2_4 <- paste0("/mnt/project/sjj/projects/phewas/v1/results/association/round2/veryhighmem/chr", c(1:17, 19:20), '/', num, "_results_chr", c(1:17, 19:20), "_maf0.00001_round2_veryhighmem_EUR.RData")
#files2_5 <- paste0("/mnt/project/sjj/projects/phewas/v1/results/association/round3/lowmem/chr", c(1:22), '/', num, "_results_chr", c(1:22), "_maf0.00001_round3_lowmem_EUR.RData")
#files2_6 <- paste0("/mnt/project/sjj/projects/phewas/v1/results/association/round3/highmem/chr", c(1:22), '/', num, "_results_chr", c(1:22), "_maf0.00001_round3_highmem_EUR.RData")
#files2_7 <- paste0("/mnt/project/sjj/projects/phewas/v1/results/association/round3/highhighmem/chr", c(1:20, 22), '/', num, "_results_chr", c(1:20, 22), "_maf0.00001_round3_highhighmem_EUR.RData")
#files2_8 <- paste0("/mnt/project/sjj/projects/phewas/v1/results/association/round3/veryhighmem/chr", c(1:6, 8, 12:13, 15:16, 19), '/', num, "_results_chr", c(1:6, 8, 12:13, 15:16, 19), "_maf0.00001_round3_veryhighmem_EUR.RData")
files2_1 <- paste0(num, "_results_chr", c(1:22), "_maf0.00001_round2_lowmem_EUR.RData")
files2_2 <- paste0(num, "_results_chr", c(1:22), "_maf0.00001_round2_highmem_EUR.RData")
files2_3 <- paste0(num, "_results_chr", c(1:22), "_maf0.00001_round2_highhighmem_EUR.RData")
files2_4 <- paste0(num, "_results_chr", c(1:17, 19:20), "_maf0.00001_round2_veryhighmem_EUR.RData")
files2_5 <- paste0(num, "_results_chr", c(1:22), "_maf0.00001_round3_lowmem_EUR.RData")
files2_6 <- paste0(num, "_results_chr", c(1:22), "_maf0.00001_round3_highmem_EUR.RData")
files2_7 <- paste0(num, "_results_chr", c(1:20, 22), "_maf0.00001_round3_highhighmem_EUR.RData")
files2_8 <- paste0(num, "_results_chr", c(1:6, 8, 12:13, 15:16, 19), "_maf0.00001_round3_veryhighmem_EUR.RData")
maf0.00001_files <- c(files2_1, files2_2, files2_3, files2_4, files2_5, files2_6, files2_7, files2_8)
maf0.00001_nfilesets <- 8
# Old MAF<0.001% run with some errors
#files2_9 <- paste0("/mnt/project/sjj/projects/phewas/v1/results/association/", num, "_results_chr", c(1:22), "_maf0.00001_EUR.RData")
files2_9 <- paste0(num, "_results_chr", c(1:22), "_maf0.00001_EUR.RData")
maf0.00001_old_files <- c(files2_9)
maf0.00001_old_nfilesets <- 1

#MAF<1% files
#for(chr in c(1:22)){
#    try(system(paste0("dx download exome-seq:/sjj/projects/phewas/v1/results/association/round3/lowmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.01_round3_lowmem_EUR.RData")))
#    try(system(paste0("dx download exome-seq:/sjj/projects/phewas/v1/results/association/round3/highmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.01_round3_highmem_EUR.RData")))
#    try(system(paste0("dx download exome-seq:/sjj/projects/phewas/v1/results/association/round3/highhighmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.01_round3_highhighmem_EUR.RData")))
#    if(chr %in% c(1:20, 22)){
#        try(system(paste0("dx download exome-seq:/sjj/projects/phewas/v1/results/association/round3/veryhighmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.01_round3_veryhighmem_EUR.RData")))
#    }
#}
for(chr in c(1:22)){
    files <- paste0(files, " ", paste0("exome-seq:/sjj/projects/phewas/v1/results/association/round3/lowmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.01_round3_lowmem_EUR.RData"))
    files <- paste0(files, " ", paste0("exome-seq:/sjj/projects/phewas/v1/results/association/round3/highmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.01_round3_highmem_EUR.RData"))
    files <- paste0(files, " ", paste0("exome-seq:/sjj/projects/phewas/v1/results/association/round3/highhighmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.01_round3_highhighmem_EUR.RData"))
    if(chr %in% c(1:20, 22)){
        files <- paste0(files, " ", paste0("exome-seq:/sjj/projects/phewas/v1/results/association/round3/veryhighmem/chr", chr, '/', num, "_results_chr", chr, "_maf0.01_round3_veryhighmem_EUR.RData"))
    }
}
#files3_1 <- paste0("/mnt/project/sjj/projects/phewas/v1/results/association/round3/lowmem/chr", c(1:22), '/', num, "_results_chr", c(1:22), "_maf0.01_round3_lowmem_EUR.RData")
#files3_2 <- paste0("/mnt/project/sjj/projects/phewas/v1/results/association/round3/highmem/chr", c(1:22), '/', num, "_results_chr", c(1:22), "_maf0.01_round3_highmem_EUR.RData")
#files3_3 <- paste0("/mnt/project/sjj/projects/phewas/v1/results/association/round3/highhighmem/chr", c(1:22), '/', num, "_results_chr", c(1:22), "_maf0.01_round3_highhighmem_EUR.RData")
#files3_4 <- paste0("/mnt/project/sjj/projects/phewas/v1/results/association/round3/veryhighmem/chr", c(1:20, 22), '/', num, "_results_chr", c(1:20, 22), "_maf0.01_round3_veryhighmem_EUR.RData")
files3_1 <- paste0(num, "_results_chr", c(1:22), "_maf0.01_round3_lowmem_EUR.RData")
files3_2 <- paste0(num, "_results_chr", c(1:22), "_maf0.01_round3_highmem_EUR.RData")
files3_3 <- paste0(num, "_results_chr", c(1:22), "_maf0.01_round3_highhighmem_EUR.RData")
files3_4 <- paste0(num, "_results_chr", c(1:20, 22), "_maf0.01_round3_veryhighmem_EUR.RData")
...
if(!(all(file.exists(maf0.001_files)) & all(file.exists(maf0.00001_files)) & all(file.exists(maf0.01_files)))){
    ...
    rawassoc_res <- inter
    write.table(rawassoc_res, file=paste0('../summary_results_phewas_all_tests_phecode', num, '_EUR.tsv'), col.names=T, row.names=F, quote=F, sep='\t', append=T)
    ...
    write.table(inter1, file=paste0('../summary_results_phewas_cauchy_phecode', num, '_EUR.tsv'), col.names=T, row.names=F, quote=F, sep='\t', append=T)
  ...
  nullmod <- get(load(paste0('/mnt/project/sjj/projects/phewas/v1/nullmodels/', jd_code, '_nullmodel_EUR.RData')))
