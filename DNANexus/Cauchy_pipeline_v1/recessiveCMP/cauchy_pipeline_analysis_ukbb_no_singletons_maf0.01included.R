...
write.table(tot, file=paste0(genename, "_", phenotype, '_cMAC', min.mac, '_rawassociation_results.tsv'), col.names=T, row.names=F, quote=F, sep='\t')
...
write.table(totres, file=paste0(genename, "_", phenotype, '_cMAC', min.mac, '_cauchy_results.tsv'), col.names=T, row.names=F, quote=F, sep='\t')
