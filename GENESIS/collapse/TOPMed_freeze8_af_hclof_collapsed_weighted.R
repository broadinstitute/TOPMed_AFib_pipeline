...
##### function start
res0<-aggreated_weighted_test(num=num,gdsfile=gdsfile,varfile=varfile,groupfile=groupfile,phenfile=phenfile,nullfile=nullfile,cutoff=cutoff,stat=stat,outfile=outfile)
